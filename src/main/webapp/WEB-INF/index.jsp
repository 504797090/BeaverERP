...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/bootstrap-select-1.13.0-dev/dist/css/bootstrap-select.css">
            ...
            <div class="modal-body" style="height: 280px">
                <div action="" class="form-inline" method="post"  role="form">
                    ...
                    <div class="form-group" style="padding-bottom: 8px;">
                        ...
                        <div class="col-md-6">
                                <select class="selectpicker " title="请选择部门" style="position: relative; left: 50px" id="bv_department" name="bv_department">
        ...
        <div class="form-horizontal col-sm-offset-3 col-md-offset-3" >
            ...
            <div class="col-sm-9 col-md-9">
                <div class="form-group">
                    ...
                    <input class="form-control required" type="text" placeholder="请填写姓名" name="username" autofocus="autofocus" maxlength="20" id="1"/>
                </div>
                <div class="form-group">
                    <i class="fa fa-lock fa-lg"></i>
                    <input class="form-control required" type="password" placeholder="请填写密码" name="password" maxlength="8" id="2"/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group col-sm-9 col-md-9" style="margin-bottom: 0">
                        <!--<label class=" control-label" >-->
                            <!--验证码 :-->
                        <!--</label>-->
                        <input  type="text" class="form-control col-sm-6" id="imgText" name="imgText" placeholder="请输入验证码">
                    </div>
                </div>
